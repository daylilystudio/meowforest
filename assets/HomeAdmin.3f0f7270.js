...
`,[y("absolute-positioned",`
 ...
 `)]),q("disabled",[q("selected, child-active",[g("&:focus-within",me)]),y("selected",[L(null,[m("icon","color: var(--n-item-icon-color-active-hover-horizontal);"),u("menu-item-content-header",`
 ...
 `)]),q("disabled",[q("selected, child-active",[g("&:focus-within",ue)]),y("selected",[L(null,[m("arrow","color: var(--n-arrow-color-active-hover);"),m("icon","color: var(--n-item-icon-color-active-hover);"),u("menu-item-content-header",`
