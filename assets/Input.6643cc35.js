...
`,[f("input, textarea",`
 ...
 `),P("&:-webkit-autofill ~",[f("placeholder","display: none;")])]),z("round",[Y("textarea","border-radius: calc(var(--n-height) / 2);")]),f("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),z("textarea",[f("placeholder","overflow: visible;")]),Y("autosize","width: 100%;"),z("autosize",[f("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `)]),P("&:hover",[f("state-border","border: var(--n-border-hover);")]),z("focus","background-color: var(--n-color-focus);",[f("state-border",`
 ...
 `),["warning","error"].map(t=>z(`${t}-status`,[Y("disabled",[b("base-loading",`
