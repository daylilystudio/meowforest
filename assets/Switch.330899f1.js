...
`,[f("children-placeholder",`
 ...
 cursor: not-allowed;
 opacity: .5;
 `)])]),lt=Object.assign(Object.assign({},ce.props),{size:{type:String,default:"medium"},value:{type:[String,Number,Boolean],default:void 0},loading:Boolean,defaultValue:{type:[String,Number,Boolean],default:!1},disabled:{type:Boolean,default:void 0},round:{type:Boolean,default:!0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array],checkedValue:{type:[String,Number,Boolean],default:!0},uncheckedValue:{type:[String,Number,Boolean],default:!1},railStyle:Function,rubberBand:{type:Boolean,default:!0},onChange:[Function,Array]});let W;const bt=A({name:"Switch",props:lt,setup(e){W===void 0&&(typeof CSS<"u"?typeof CSS.supports<"u"?W=CSS.supports("width","max(1px)"):W=!1:W=!0);const{mergedClsPrefixRef:n,inlineThemeDisabled:o}=ue(e),t=ce("Switch","-switch",st,at,e,n),i=Pe(e),{mergedSizeRef:r,mergedDisabledRef:a}=i,s=V(e.defaultValue),p=ee(e,"value"),u=Ke(p,s),y=R(()=>u.value===e.checkedValue),w=V(!1),d=V(!1),m=R(()=>{const{railStyle:l}=e;if(!!l)return l({focused:d.value,checked:y.value})});function b(l){const{"onUpdate:value":x,onChange:j,onUpdateValue:O}=e,{nTriggerFormInput:H,nTriggerFormChange:K}=i;x&&Z(x,l),O&&Z(O,l),j&&Z(j,l),s.value=l,H(),K()}function g(){const{nTriggerFormFocus:l}=i;l()}function $(){const{nTriggerFormBlur:l}=i;l()}function v(){e.loading||a.value||(u.value!==e.checkedValue?b(e.checkedValue):b(e.uncheckedValue))}function c(){d.value=!0,g()}function M(){d.value=!1,$(),w.value=!1}function _(l){e.loading||a.value||l.key===" "&&(u.value!==e.checkedValue?b(e.checkedValue):b(e.uncheckedValue),w.value=!1)}function S(l){e.loading||a.value||l.key===" "&&(l.preventDefault(),w.value=!0)}const C=R(()=>{const{value:l}=r,{self:{opacityDisabled:x,railColor:j,railColorActive:O,buttonBoxShadow:H,buttonColor:K,boxShadowFocus:ve,loadingColor:be,textColor:me,iconColor:ge,[z("buttonHeight",l)]:I,[z("buttonWidth",l)]:we,[z("buttonWidthPressed",l)]:ye,[z("railHeight",l)]:F,[z("railWidth",l)]:P,[z("railBorderRadius",l)]:Se,[z("buttonBorderRadius",l)]:xe},common:{cubicBezierEaseInOut:Re}}=t.value;let U,X,Q;return W?(U=`calc((${F} - ${I}) / 2)`,X=`max(${F}, ${I})`,Q=`max(${P}, calc(${P} + ${I} - ${F}))`):(U=G((N(F)-N(I))/2),X=G(Math.max(N(F),N(I))),Q=N(F)>N(I)?P:G(N(P)+N(I)-N(F))),{"--n-bezier":Re,"--n-button-border-radius":xe,"--n-button-box-shadow":H,"--n-button-color":K,"--n-button-width":we,"--n-button-width-pressed":ye,"--n-button-height":I,"--n-height":X,"--n-offset":U,"--n-opacity-disabled":x,"--n-rail-border-radius":Se,"--n-rail-color":j,"--n-rail-color-active":O,"--n-rail-height":F,"--n-rail-width":P,"--n-width":Q,"--n-box-shadow-focus":ve,"--n-loading-color":be,"--n-text-color":me,"--n-icon-color":ge}}),k=o?De("switch",R(()=>r.value[0]),C,e):void 0;return{handleClick:v,handleBlur:M,handleFocus:c,handleKeyup:_,handleKeydown:S,mergedRailStyle:m,pressed:w,mergedClsPrefix:n,mergedValue:u,checked:y,mergedDisabled:a,cssVars:o?void 0:C,themeClass:k==null?void 0:k.themeClass,onRender:k==null?void 0:k.onRender}},render(){const{mergedClsPrefix:e,mergedDisabled:n,checked:o,mergedRailStyle:t,onRender:i,$slots:r}=this;i==null||i();const{checked:a,unchecked:s,icon:p,"checked-icon":u,"unchecked-icon":y}=r,w=!(q(p)&&q(u)&&q(y));return h("div",{role:"switch","aria-checked":o,class:[`${e}-switch`,this.themeClass,w&&`${e}-switch--icon`,o&&`${e}-switch--active`,n&&`${e}-switch--disabled`,this.round&&`${e}-switch--round`,this.loading&&`${e}-switch--loading`,this.pressed&&`${e}-switch--pressed`,this.rubberBand&&`${e}-switch--rubber-band`],tabindex:this.mergedDisabled?void 0:0,style:this.cssVars,onClick:this.handleClick,onFocus:this.handleFocus,onBlur:this.handleBlur,onKeyup:this.handleKeyup,onKeydown:this.handleKeydown},h("div",{class:`${e}-switch__rail`,"aria-hidden":"true",style:t},E(a,d=>E(s,m=>d||m?h("div",{"aria-hidden":!0,class:`${e}-switch__children-placeholder`},h("div",{class:`${e}-switch__rail-placeholder`},h("div",{class:`${e}-switch__button-placeholder`}),d),h("div",{class:`${e}-switch__rail-placeholder`},h("div",{class:`${e}-switch__button-placeholder`}),m)):null)),h("div",{class:`${e}-switch__button`},E(p,d=>E(u,m=>E(y,b=>h(Te,null,{default:()=>this.loading?h(We,{key:"loading",clsPrefix:e,strokeWidth:20}):this.checked&&(m||d)?h("div",{class:`${e}-switch__button-icon`,key:m?"checked-icon":"icon"},m||d):!this.checked&&(b||d)?h("div",{class:`${e}-switch__button-icon`,key:b?"unchecked-icon":"icon"},b||d):null})))),E(a,d=>d&&h("div",{key:"checked",class:`${e}-switch__checked`},d)),E(s,d=>d&&h("div",{key:"unchecked",class:`${e}-switch__unchecked`},d)))))}});export{vt as N,Je as a,pt as b,bt as c};
