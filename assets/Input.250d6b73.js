...
`,[P(">",[f("clear",`
 ...
 `,[ur({originalTransform:"translateX(-50%) translateY(-50%)",left:"50%",top:"50%"})])])]),Ce=I({name:"BaseClear",props:{clsPrefix:{type:String,required:!0},show:Boolean,onClear:Function},setup(t){return We("-base-clear",Po,_e(t,"clsPrefix")),{handleMouseDown(a){a.preventDefault()}}},render(){const{clsPrefix:t}=this;return n("div",{class:`${t}-base-clear`},n(cr,null,{default:()=>{var a,o;return this.show?n("div",{key:"dismiss",class:`${t}-base-clear__clear`,onClick:this.onClear,onMousedown:this.handleMouseDown,"data-clear":!0},Q(this.$slots.icon,()=>[n(le,{clsPrefix:t},{default:()=>n(So,null)})])):n("div",{key:"icon",class:`${t}-base-clear__placeholder`},(o=(a=this.$slots).placeholder)===null||o===void 0?void 0:o.call(a))}}))}}),Mo=I({name:"InternalSelectionSuffix",props:{clsPrefix:{type:String,required:!0},showArrow:{type:Boolean,default:void 0},showClear:{type:Boolean,default:void 0},loading:{type:Boolean,default:!1},onClear:Function},setup(t,{slots:a}){return()=>{const{clsPrefix:o}=t;return n(hr,{clsPrefix:o,class:`${o}-base-suffix`,strokeWidth:24,scale:.85,show:t.loading},{default:()=>t.showArrow?n(Ce,{clsPrefix:o,show:t.showClear,onClear:t.onClear},{placeholder:()=>n(le,{clsPrefix:o,class:`${o}-base-suffix__arrow`},{default:()=>Q(a.default,()=>[n(Co,null)])})}):null})}}}),Fo={paddingTiny:"0 8px",paddingSmall:"0 10px",paddingMedium:"0 12px",paddingLarge:"0 14px",clearSize:"16px"},To=t=>{const{textColor2:a,textColor3:o,textColorDisabled:c,primaryColor:v,primaryColorHover:s,inputColor:d,inputColorDisabled:i,borderColor:l,warningColor:h,warningColorHover:m,errorColor:p,errorColorHover:C,borderRadius:L,lineHeight:M,fontSizeTiny:se,fontSizeSmall:V,fontSizeMedium:de,fontSizeLarge:F,heightTiny:$,heightSmall:O,heightMedium:k,heightLarge:ue,actionColor:D,clearColor:R,clearColorHover:A,clearColorPressed:W,placeholderColor:H,placeholderColorDisabled:j,iconColor:ce,iconColorDisabled:he,iconColorHover:U,iconColorPressed:fe}=t;return Object.assign(Object.assign({},Fo),{countTextColorDisabled:c,countTextColor:o,heightTiny:$,heightSmall:O,heightMedium:k,heightLarge:ue,fontSizeTiny:se,fontSizeSmall:V,fontSizeMedium:de,fontSizeLarge:F,lineHeight:M,lineHeightTextarea:M,borderRadius:L,iconSize:"16px",groupLabelColor:D,groupLabelTextColor:a,textColor:a,textColorDisabled:c,textDecorationColor:a,caretColor:v,placeholderColor:H,placeholderColorDisabled:j,color:d,colorDisabled:i,colorFocus:d,groupLabelBorder:`1px solid ${l}`,border:`1px solid ${l}`,borderHover:`1px solid ${s}`,borderDisabled:`1px solid ${l}`,borderFocus:`1px solid ${s}`,boxShadowFocus:`0 0 0 2px ${be(v,{alpha:.2})}`,loadingColor:v,loadingColorWarning:h,borderWarning:`1px solid ${h}`,borderHoverWarning:`1px solid ${m}`,colorFocusWarning:d,borderFocusWarning:`1px solid ${m}`,boxShadowFocusWarning:`0 0 0 2px ${be(h,{alpha:.2})}`,caretColorWarning:h,loadingColorError:p,borderError:`1px solid ${p}`,borderHoverError:`1px solid ${C}`,colorFocusError:d,borderFocusError:`1px solid ${C}`,boxShadowFocusError:`0 0 0 2px ${be(p,{alpha:.2})}`,caretColorError:p,clearColor:R,clearColorHover:A,clearColorPressed:W,iconColor:ce,iconColorDisabled:he,iconColorHover:U,iconColorPressed:fe,suffixTextColor:a})},zo={name:"Input",common:fr,self:To},Ao=zo,Be=vr("n-input");function ko(t){let a=0;for(const o of t)a++;return a}function ie(t){return t===""||t==null}function Do(t){const a=w(null);function o(){const{value:s}=t;if(!(s!=null&&s.focus)){v();return}const{selectionStart:d,selectionEnd:i,value:l}=s;if(d==null||i==null){v();return}a.value={start:d,end:i,beforeText:l.slice(0,d),afterText:l.slice(i)}}function c(){var s;const{value:d}=a,{value:i}=t;if(!d||!i)return;const{value:l}=i,{start:h,beforeText:m,afterText:p}=d;let C=l.length;if(l.endsWith(p))C=l.length-p.length;else if(l.startsWith(m))C=m.length;else{const L=m[h-1],M=l.indexOf(L,h-1);M!==-1&&(C=M+1)}(s=i.setSelectionRange)===null||s===void 0||s.call(i,C,C)}function v(){a.value=null}return we(t,v),{recordCursor:o,restoreCursor:c}}const $e=I({name:"InputWordCount",setup(t,{slots:a}){const{mergedValueRef:o,maxlengthRef:c,mergedClsPrefixRef:v}=Re(Be),s=z(()=>{const{value:d}=o;return d===null||Array.isArray(d)?0:ko(d)});return()=>{const{value:d}=c,{value:i}=o;return n("span",{class:`${v.value}-input-word-count`},mr(a.default,{value:i===null||Array.isArray(i)?"":i},()=>[d===void 0?s.value:`${s.value} / ${d}`]))}}}),$o=b("input",`
 max-width: 100%;
 cursor: text;
 line-height: 1.5;
 z-index: auto;
...
`,[f("input, textarea",`
 ...
 `),P("&:-webkit-autofill ~",[f("placeholder","display: none;")])]),T("round",[Y("textarea","border-radius: calc(var(--n-height) / 2);")]),f("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),T("textarea",[f("placeholder","overflow: visible;")]),Y("autosize","width: 100%;"),T("autosize",[f("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 `),["warning","error"].map(t=>T(`${t}-status`,[Y("disabled",[b("base-loading",`
